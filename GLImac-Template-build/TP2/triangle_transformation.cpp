/* transformation effectuées lors de l'exercice
    //gl_Position = vec4(aVertexPosition.x + 0.5, aVertexPosition.y + 0.5, 0, 1);
    gl_Position = vec4(aVertexPosition * 2.0, 0, 1);
    gl_Position = vec4(aVertexPosition * vec2(2.0,0.5), 0, 1);

    avec les matrices
    vFragColor = aVertexColor;
    vec2 transformed = (translate(0.5,0.5)*vec3(aVertexPosition, 1)).xy;
