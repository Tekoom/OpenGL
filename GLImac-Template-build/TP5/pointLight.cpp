...
int main(int argc, char** argv) {
  ...
  GLint locationLightPos = glGetUniformLocation(idProg, "uLightPos_vs");
  ...
  while(!done) {
    ...
    NormalMatrix = glm::transpose(glm::inverse(MVMatrix));
      ...
      glUniformMatrix4fv(
        ...
        glUniform3fv(locationKs, 1, glm::value_ptr(glm::vec3(1.,1.,1.)));
        glUniform1f(locationShininess, 1.);
        glm::vec4 direction = ViewMatrix * glm::vec4(1.,1.,1.,1.);
        glUniform3fv(locationLightPos, 1, glm::value_ptr(direction));
        glUniform3fv(locationLightIntensity, 1, glm::value_ptr(glm::vec3(8.,8.,8.)));
            ...
            for(int i=0; i<nbMoon; i++){
              ...
              glUniformMatrix4fv(
                ...
                glUniformMatrix4fv(
                  ...
                  1,
                  GL_FALSE,
                  glm::value_ptr(ViewMatrix*MVMatrix));
